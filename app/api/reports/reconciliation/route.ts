...
export async function GET(req: NextRequest) {
  ...
  const html = `<!DOCTYPE html><html><head><meta charset="utf-8"><style>
    ...
    <table border="1" width="100%" cellpadding="6" cellspacing="0">
      <thead><tr><th bgcolor="#f5f5f5">\u2116</th><th bgcolor="#f5f5f5">\u0420\u0435\u0439\u0441</th><th bgcolor="#f5f5f5">\u0414\u0430\u0442\u0430</th><th bgcolor="#f5f5f5">\u041C\u0430\u0440\u0448\u0440\u0443\u0442</th><th class="num" bgcolor="#f5f5f5">\u041D\u0430\u0447\u0438\u0441\u043B\u0435\u043D\u043E (\u058F)</th><th class="num" bgcolor="#f5f5f5">\u041E\u043F\u043B\u0430\u0447\u0435\u043D\u043E (\u058F)</th><th class="num" bgcolor="#f5f5f5">\u0421\u0430\u043B\u044C\u0434\u043E (\u058F)</th></tr></thead>
      <tbody>
        ...
        <tr class="total-row"><td colspan="4" bgcolor="#f9f9f9">\u0418\u0442\u043E\u0433\u043E</td><td class="num" bgcolor="#f9f9f9">${totalIncome.toLocaleString('ru-RU')}</td><td class="num" bgcolor="#f9f9f9">${totalPaid.toLocaleString('ru-RU')}</td><td class="num" bgcolor="#f9f9f9">${(totalIncome - totalPaid).toLocaleString('ru-RU')}</td></tr>
      </tbody>
    </table>
